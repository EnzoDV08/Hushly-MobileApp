...
const slides: Slide[] = [
  {
    key: '1',
    title: 'Welcome to Hushly',
    description: 'Relax. Recenter. Recharge.',
    image: require('../assets/HushlyLogo2.png'),
  },
  {
    key: '2',
    title: 'Find Your Calm',
    description: 'Ambient sounds and breathing exercises.',
          ...
          <View style={styles.dotsInCard}>
            {slides.map((_, i) => {
              ...
              return (
                <Animated.View
                  key={i}
                  style={[styles.dot, { backgroundColor: isActive ? '#7A00FF' : '#D1D5DB' }, dotStyle]}
                />
              );
            })}
          </View>
